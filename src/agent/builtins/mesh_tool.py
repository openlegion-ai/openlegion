...
@skill(
    name="emit_event",
    description=(
        "Emit a custom event to outbound webhooks. Outbound webhook subscribers "
        "receive these as event type 'custom' with the event_name included in "
        "the data payload alongside your provided data."
    ),
    parameters={
        "type": "object",
        "properties": {
